...
public:
    ...
    modp_(const gfp_<X, M> &other, const Zp_Data &ZpD) : modp_()
    {
    ...
    template <int X, int M>
    modp_(const gfpvar_<X, M> &other, const Zp_Data &ZpD) : modp_()
    {
    ...
    template <int M>
    friend void to_modp(modp_<M> &ans, const mpz_class &x, const Zp_Data &ZpD);
    ...
    template <int M>
    friend void Sub(modp_<M> &ans, const modp_<M> &x, const modp_<M> &y, const Zp_Data &ZpD);
    template <int M>
    ...
    template <int M>
    friend void Power(modp_<M> &ans, const modp_<M> &x, const bigint &exp, const Zp_Data &ZpD);
