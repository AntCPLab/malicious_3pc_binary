...
public:
    ...
    Rep3Share()
    {
        if (BUILDING_SHARE_PROCESS & REP3SHARE_PROCESS) {
            cout << "In Rep3Share()" << endl;
        }
    }
    template<class U>
    ...
    {
        if (BUILDING_SHARE_PROCESS & REP3SHARE_PROCESS) {
            cout << "In Rep3Share(const U& other)" << endl;
        }
    }
    ...
    Rep3Share(T value, int my_num, const T& alphai = {})
    {
        ...
        if (BUILDING_SHARE_PROCESS & REP3SHARE_PROCESS) {
            cout << "In Rep3Share(T value, int my_num, const T& alphai = {})" << endl;
    ...
    {
        if (BUILDING_SHARE_PROCESS & REP3SHARE_PROCESS) {
            cout << "In Rep3Share::assign(const char* buffer)" << endl;
